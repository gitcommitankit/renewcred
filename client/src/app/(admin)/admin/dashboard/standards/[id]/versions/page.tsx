    ...
    <>
      <div className="flex flex-col sm:flex-row sm:items-center gap-3 mb-6">
        <div className="flex-1">
          <Link
            href={`/admin/dashboard/standards/${params.id}`}
            className="inline-flex items-center gap-1.5 text-sm text-warm-gray-500 hover:text-charcoal-900 mb-1 transition-colors"
          >
            <ArrowLeft size={15} />
            ...
            <tbody>
              {versions.map((v: VersionSummary) => (
                ...
                >
                  ...
                  <td className="px-5 py-3.5 text-warm-gray-500 text-xs">
